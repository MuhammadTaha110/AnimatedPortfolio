      ...
      >
        ...
        >
          <span className="about-1 leading-tight">
            ...
            Next.js/React/TypeScript applications and Node.js backends.{" "}
          </span>
          <span className="about-2 leading-tight">
            Founded and architected TestHub, a SaaS platform, end-to-end — and
            won two frontend hackathons under time pressure.{" "}
          </span>
        </h1>
      </div>
    </section>
