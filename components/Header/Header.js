...
const Header = () => {
  ...
  return (
    <>
      ...
      <nav className="relative w-full fixed top-0 py-8 z-[250] select-none bg-gradient-to-b from-gray-light-1/95 to-transparent dark:from-black dark:to-transparent shadow-sm dark:shadow-black transition-all duration-300">
