...
const Header = () => {
  ...
  return (
    <>
      ...
      <nav className="relative w-full fixed top-0 z-[250] select-none bg-gradient-to-b from-gray-light-1/95 to-transparent pt-2 dark:from-black dark:to-transparent transition-all duration-300">
